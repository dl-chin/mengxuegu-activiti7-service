...
import com.mengxuegu.workflow.cmd.DelelteExecutionCommand;
import com.mengxuegu.workflow.cmd.DeleteTaskCommand;
import com.mengxuegu.workflow.enums.BusinessStatusEnum;
import com.mengxuegu.workflow.req.TaskCompleteREQ;
    ...
    public Result getBackNodes(@RequestParam String taskId) {
        try {
            Task task = taskService.createTaskQuery()
                    ...
                    .singleResult();
            if( task == null ) {
                return Result.error("没有此任务或不是该任务办理人");
            }
            // 查询历史任务节点
           /* List<HistoricTaskInstance> list = historyService.createHistoricTaskInstanceQuery()
            ...
            e.printStackTrace();
            return Result.error("查询驳回节点失败：" + e.getMessage());
        }
    }
